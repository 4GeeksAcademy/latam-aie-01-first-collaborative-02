# Documento de Contexto de Marca: **L’Éclat Studio**

**L’Éclat Studio** es una firma de moda francesa con sede en el distrito Le Marais, París. Se define por un estilo **"Minimalismo de Lujo"**, fusionando la sastrería clásica francesa con cortes arquitectónicos modernos. Su propuesta de valor se basa en la sostenibilidad y la transparencia de materiales.
...
| :--- | :--- | :--- | :--- |
| **Veste de L'Aube** | Sastrería | **245,00 €** | Blazer estructurado en lino orgánico color crema. |
| **Pantalon Marais** | Pantalones | **120,00 €** | Pantalón de corte recto en gabardina de algodón. |
| **Chemise Riva** | Camisas | **85,00 €** | Camisa de seda ligera con cuello mao y botones de nácar. |
| **Bottes Brume** | Calzado | **310,00 €** | Botas de cuero hechas a mano con suela ergonómica. |
| **Écharpe Soie** | Accesorios | **65,00 €** | Pañuelo 100% seda con estampado geométrico sutil. |
...
### 🎨 Guía de Estilo Visual (Para consistencia)
* **Paleta de Colores:** Negro Carbón (`#1A1A1A`), Blanco Hueso (`#F9F9F9`) y Acento Dorado Arena (`#C5A059`).
* **Tipografía:** *Playfair Display* para títulos (elegancia) y *Inter* o *Montserrat* para cuerpo de texto (legibilidad técnica).
* **Fotografía:** Estilo editorial, fondos neutros y mucho espacio negativo.

---

### 🛠️ Flujo de Usuario (Resumen para Agentes)
1.  **Home:** Impacto visual con el "Veste de L'Aube".
2.  **Catálogo:** Filtrado por tallas (S, M, L, XL) y categorías.
3.  **Producto:** Foco en la composición (ej. "Lino 100% biodegradable").
4.  **Carrito:** Cálculo automático de IVA (20% estándar Francia) y envío.
5.  **Checkout:** Proceso lineal de 3 pasos sin distracciones.
